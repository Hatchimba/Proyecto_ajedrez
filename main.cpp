...
void juego(Tablero ajedrez){
    ...
    while (true){
        ...
        if (seleccion == 1){
            ...
            cout << "Jugador 2: ";
            cin >> id2;
            Piezas *PN1 = new Peones(id2, "PN", 2, 1, 0);
            Piezas *PN2 = new Peones(id2, "PN", 2, 2, 0);
            Piezas *PN3 = new Peones(id2, "PN", 2, 3, 0);
            Piezas *PN4 = new Peones(id2, "PN", 2, 4, 0);
            Piezas *PN5 = new Peones(id2, "PN", 2, 5, 0);
            Piezas *PN6 = new Peones(id2, "PN", 2, 6, 0);
            Piezas *PN7 = new Peones(id2, "PN", 2, 7, 0);
            Piezas *PN8 = new Peones(id2, "PN", 2, 8, 0);
            Piezas *PB1 = new Peones(id1, "PB", 7, 1, 0);
            Piezas *PB2 = new Peones(id1, "PB", 7, 2, 0);
            Piezas *PB3 = new Peones(id1, "PB", 7, 3, 0);
            Piezas *PB4 = new Peones(id1, "PB", 7, 4, 0);
            Piezas *PB5 = new Peones(id1, "PB", 7, 5, 0);
            Piezas *PB6 = new Peones(id1, "PB", 7, 6, 0);
            Piezas *PB7 = new Peones(id1, "PB", 7, 7, 0);
            Piezas *PB8 = new Peones(id1, "PB", 7, 8, 0);

            Piezas *AB1 = new Alfiles(id1, "AB", 8, 3, 0);
            Piezas *AB2 = new Alfiles(id1, "AB", 8, 6, 0);
            Piezas *AN1 = new Alfiles(id2, "AN", 1, 3, 0);
            Piezas *AN2 = new Alfiles(id2, "AN", 1, 6, 0);

            Piezas *TB1 = new Torres(id1, "TB", 8, 1, 0);
            Piezas *TB2 = new Torres(id1, "TB", 8, 8, 0);
            Piezas *TN1 = new Torres(id2, "TN", 1, 1, 0);
            Piezas *TN2 = new Torres(id2, "TN", 1, 8, 0);

            Piezas *CB1 = new Caballos(id1, "CB", 8, 2, 0);
            Piezas *CB2 = new Caballos(id1, "CB", 8, 7, 0);
            Piezas *CN1 = new Caballos(id2, "CN", 1, 2, 0);
            Piezas *CN2 = new Caballos(id2, "CN", 1, 7, 0);

            Piezas *KB = new Reyes(id1, "KB", 8, 5, 0);
            Piezas *KN = new Reyes(id2, "KN", 1, 5, 0);

            Piezas *QB = new Reinas(id1, "QB", 8, 4, 0);
            Piezas *QN = new Reinas(id2, "QN", 1, 4, 0);
